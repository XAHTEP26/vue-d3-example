...
export default {
  ...
  data() {
    return {
      ...
      data: [],
      tweenedData: [],
      /* data1: demoData.map(d => ({ date: d.date, value: 0 })),
      data2: demoData, */
      data1: [
        { ser1: 0.3, ser2: 4 },
        { ser1: 2, ser2: 16 },
  ...
  watch: {
    data(newValue, oldValue) {
      const interpolator = interpolate(oldValue, newValue);
      ...
      animate({
        ...
        // timing: d => d ** 2,
        draw(progress) {
          vm.tweenedData = interpolator(progress);
        },
      });
    },
  },
  computed: {
    ...
    scaleX() {
      /* return scaleTime()
        .domain(extent(this.tweenedData, d => d.date))
        .range([0, this.width - this.margin.left - this.margin.right]); */
      return scaleLinear()
        .range([0, this.width - this.margin.left - this.margin.right])
        .domain([0, max(this.tweenedData, d => d.ser1)]);
    },
    scaleY() {
      /* return scaleLinear()
        .domain(extent(this.tweenedData, d => d.value))
        .range([this.height - this.margin.top - this.margin.bottom, 0]); */
      return scaleLinear()
        .range([this.height - this.margin.top - this.margin.bottom, 0])
        .domain([0, max(this.tweenedData, d => d.ser2)]);
    },
  },
  methods: {
    update(data) {
